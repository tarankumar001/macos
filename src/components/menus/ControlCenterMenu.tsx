  ...
  return (
    ...
    >
      ...
      <div className="cc-grid col-span-2 p-2 hstack space-x-3">
        ...
        >
          {dark ? (
            <span className="i-bi:moon text-base" />
          ) : (
            <span className="i-bi:sun text-base" />
          )}
        </motion.div>
      ...
      <div className="cc-grid col-span-4 px-2.5 py-2 space-y-1 flex flex-col justify-around">
        ...
        <SliderComponent icon="i-bi:sun" value={brightness} setValue={setBrightness} />
      </div>
      <div className="cc-grid col-span-4 px-2.5 py-2 space-y-1 flex flex-col justify-around">
        <span className="font-medium ml-0.5">Sound</span>
        <SliderComponent icon="i-bi:volume-up" value={volume} setValue={setVolume} />
      </div>
