            ...
            <span className="relative flex-1 font-bold" text="gray-900 dark:gray-100">
              ...
              {item.link && (
                <a
                  ...
                  href={item.link}
                  target={item.link.endsWith(".zip") ? "_self" : "_blank"}
                  rel="noreferrer"
                  download={item.link.endsWith(".zip") ? "porjects.zip" : undefined}
                  title={item.link.endsWith(".zip") ? "Download porjects.zip" : undefined}
                >
                  <span
                    className={
                      item.link.endsWith(".zip")
                        ? "i-ri:download-line text-c-500"
                        : "i-ant-design:link-outlined text-c-500"
                    }
                  />
                </a>
              )}
