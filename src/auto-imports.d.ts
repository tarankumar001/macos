...
export {}
declare global {
  const AboutThisMac: typeof import('./components/apps/AboutThisMac')['default']
  ...
  const CatApp: typeof import('./components/apps/CatApp')['default']
  ...
  const PlaceholderApp: typeof import('./components/apps/PlaceholderApp')['default']
  const Safari: typeof import('./components/apps/Safari')['default']
  const SpinningCat: typeof import('./components/SpinningCat')['default']
  const Spotlight: typeof import('./components/Spotlight')['default']
  const SystemPreferences: typeof import('./components/apps/SystemPreferences')['default']
